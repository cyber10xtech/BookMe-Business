...
const HomePage = () => {
  ...
  const handleShareProfile = async () => {
    ...
    try {
      const result = await shareProviderProfile(profile.id, {
        businessName: profile.business_name,
        description: profile.business_description,
        imageUrl: profile.business_logo_url || profile.cover_image_url,
      });
      ...
      <div className="flex flex-col items-center -mt-14 relative z-10">
        ...
        <div className="flex flex-wrap justify-center gap-3 mt-4">
          {[{ label: "Edit Profile", icon: Edit2,   action: () => navigate("/edit-profile") },
            ...
            { label: "Share",        icon: Share2,  action: handleShareProfile }
