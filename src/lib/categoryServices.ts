...
const CONFIG: Record<string, CategoryServiceConfig> = {
  ...
  nail_techs: {
    lockedServices: [
      { key: "manicure", name: "Manicure", emoji: "💅", defaultPrice: 3000, duration: "30 mins" },
      { key: "pedicure", name: "Pedicure", emoji: "🦶", defaultPrice: 4000, duration: "45 mins" },
      { key: "gel_nails", name: "Gel Nails", emoji: "✨", defaultPrice: 6000, duration: "1 hr" },
    ],
    subServices: [],
  },
  ...
  skin_care: {
    lockedServices: [
      { key: "facial_treatment", name: "Facial Treatment", emoji: "🧖", defaultPrice: 10000, duration: "45 mins" },
      { key: "acne_treatment", name: "Acne Treatment", emoji: "💆", defaultPrice: 12000, duration: "1 hr" },
      { key: "chemical_peel", name: "Chemical Peel", emoji: "🧴", defaultPrice: 15000, duration: "1 hr" },
    ],
    subServices: [],
  },
  ...
  piercings: {
    lockedServices: [
      { key: "ear_piercing", name: "Ear Piercing", emoji: "👂", defaultPrice: 5000, duration: "20 mins" },
      { key: "nose_piercing", name: "Nose Piercing", emoji: "👃", defaultPrice: 6000, duration: "20 mins" },
      { key: "cartilage_piercing", name: "Cartilage Piercing", emoji: "🦻", defaultPrice: 7000, duration: "30 mins" },
    ],
    subServices: [],
  },
};
